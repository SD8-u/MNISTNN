...
namespace MNistNN
{
    internal class ConvolutionLayerNetwork
    {
        ...
        public ConvolutionLayerNetwork(int iX, int iY, int iZ, int[,] structure, double[,,] input)
        {
        ...
        {
            int k1 = (m1.GetLength(0) - m2.GetLength(0)) + 1;
            int k2 = (m1.GetLength(1) - m2.GetLength(1)) + 1;
            ...
            for(int x = 0; x < k1; x++)
            {
                ...
                {
                    double sum = 0;
                    for(int z = k1; z < k1 + m2.GetLength(0); z++)
                    {
                        for(int w = k2; w < k2 + m2.GetLength(1); w++)
                        {
